...
const TaskHistory = () => {
    const history = [
        { date: '01-03-2024', action: 'Task created', updatedBy: 'Agent ABC', status: 'Pending' },
    ...
    return (
        <div className="min-h-screen bg-orange-100 flex items-center justify-center p-5">
            <div className="max-w-3xl w-full bg-orange-200 p-6 rounded-lg shadow-md">
                <h1 className="bg-blue-900 text-white px-4 py-2 text-lg rounded mb-4">Task History</h1>
