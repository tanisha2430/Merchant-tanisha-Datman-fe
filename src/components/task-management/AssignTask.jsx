...
const AssignTask = () => {
    ...
    const scheduleReminder = (task) => {
        ...
        if (reminderDateTime > now) {
            ...
            console.log(`Time until reminder: ${timeDiff / 1000} seconds`);
    ...
    const handleSubmit = async (e) => {
        ...
        navigate(`/merchant/${taskData.merchantId}/tasks`);
    };
                ...
                <div className="border p-6 rounded-lg">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Select
                                options={agents.map((agent) => ({ value: agent._id, label: agent.username }))}
                        ...
                        <div>
                            ...
                            <Select
                                options={interactions?.map((interaction) => ({ value: interaction._id, label: interaction.title }))}
